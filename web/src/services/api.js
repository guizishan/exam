...
export async function queryQuestionByTech(params) {
  return request(`/api2/question/queryQuestionByTech?${stringify(params)}`);
}
...
export async function paperListInit() {
  return request('/api2/paper/init');
}
export async function paperAdd(params) {
